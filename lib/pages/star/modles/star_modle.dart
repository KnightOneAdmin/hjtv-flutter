...
class StarModle {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "seriesList": seriesList == null
            ? null
            : List<dynamic>.from(seriesList!.map((x) => x.toJson())),
...
class AlbumCfg {
  ...
  factory AlbumCfg.fromJson(Map<String, dynamic> json) => AlbumCfg(
        famineUpdate:
            json["famineUpdate"] == null ? null : json["famineUpdate"],
      );
