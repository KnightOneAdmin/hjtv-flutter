...
class ThemeUtils {
  ...
  static get navigationTitle{
    ...
    return TextStyle(color: isDarkModel == true ?Colours.dark_text:Color(0xff262626),
        fontSize: 17.sp,
  ...
  static get title_15{
    return TextStyle(color: isDarkModel == true ?Colours.dark_text:Colours.balck_85,
        fontSize: 15.sp,
        fontWeight: FontWeight.w500,
        letterSpacing: 0.4,
        height: 1.4
  ...
  static get body_14_50{
    return TextStyle(color: isDarkModel == true ?Colours.dark_text_75:Colours.balck_50,
        fontSize: 14.sp,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.3,
        height: 1.42
  ...
  static get body_14_25{
    return TextStyle(color: isDarkModel == true ?Colours.dark_text_30:Colours.balck_25,
        fontSize: 14.sp,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.3,
        height: 1.42
  ...
  static get body_12_50{
    return TextStyle(color: isDarkModel == true ?Colours.dark_text_65:Colours.balck_50,
        fontSize: 12.sp,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.25,
        height: 1.5
  ...
  static get body_12_35{
    return TextStyle(color: isDarkModel == true ?Colours.dark_text_65:Colours.balck_35,
        fontSize: 12.sp,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.25,
        height: 1.5
  ...
  static get body_11{
    return TextStyle(color: isDarkModel == true ?Colours.dark_text_50:Colours.balck_35,
        fontSize: 11.sp,
        fontWeight: FontWeight.w400,
        letterSpacing: 0.25,
        height: 1.5
  ...
  static get inactiveColor{
    ...
    return isDarkModel == true ? Color.fromRGBO(207, 207, 207, 1):Color.fromRGBO(179, 179, 179, 1);
  }

  static get borderColor{

    return isDarkModel == true  ? Color.fromRGBO(94, 94, 94, 1):Color.fromRGBO(232, 236, 239, 1);
  }

  static get refreshColor{

    return isDarkModel == true  ? Color.fromRGBO(207, 207, 207, 1):Color.fromRGBO(0, 0, 0, 0.85);
  }

  static get bodyText14_bronw{

    return TextStyle(color: Colours.brown,fontSize:14.sp,
        height: 1.5);
  }
  ...
  static ThemeData light(){
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        // TextField输入文字颜色
        hintStyle: TextStyle(color: Colours.balck_25,fontSize: 14,fontWeight: FontWeight.w400),
      ),
      appBarTheme: AppBarTheme(
        elevation: 0.0,
        color:  Colors.white,
